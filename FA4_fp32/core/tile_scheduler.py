...
# Compatibility aliases for the stripped varlen / LPT-bwd schedulers.
# SM90 fwd/bwd still import these symbols but they're only used in
# const_expr-False branches (varlen path, deterministic LPT bwd).
SingleTileVarlenScheduler = SingleTileScheduler
SingleTileLPTBwdScheduler = SingleTileLPTScheduler
